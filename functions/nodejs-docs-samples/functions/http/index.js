...
const stringiffy = require('json-stringify');
const compatible = require("firebase-functions/lib/logger/compat");
...
exports.helloConsole = (req, res) => {
  ...
  try {
    ...
    console.error("STRINGIFFY BEGINNING REQUEST |", stringiffy(req));
    console.error("STRINGIFFY BEGINNING RESPONSE |", stringiffy(res));
    ...
    //log err.stack and err.message
    console.error("ERR ||| ", err);
    console.error("ERR Stack | ", JSON.stringify(err.stack));
    console.error("ERR Stack | ", JSON.stringify(err.message));
    console.error("STRINGIFFY ERROR REQUEST BEGIN |||");
    console.error(req);
    console.error("STRINGIFFY ERROR REQUEST END |||");

    console.error("STRINGIFFY ERROR RESPONSE BEGIN |||");
    console.error(res);
    console.error("STRINGIFFY ERROR RESPONSE END |||");

    functions.logger.log("Hello from info. Here's an error object:", err);
